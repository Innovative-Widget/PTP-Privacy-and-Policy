...
### Introduction  
Our privacy policy will help you understand what information we collect at *[PTP]*, how *[PTP]* use it, and what choices you have.
*[Innovative Widget]* built the *[PTP]* app as a free app. This SERVICE is provided by *[Innovative Widget]* at no cost and is intended for use as is.
...
Contact Information:  
Email: *[developer@innovativewidget.com]*  
